...
<form name="frm" action="/DispatcherServlet?command=adm_dressroom_manager_edit_act" method="post" onsubmit="return fn_dress_edit()">
...
function fn_dress_remove(dressroomInfoSEQ){
	if(confirm('드레스룸을 정말 삭제 하시겠습니까?')){
		location.href='/DispatcherServlet?command=adm_dressroom_manager_remove_act&dressroomInfoSEQ=' + dressroomInfoSEQ;
	}
}
</script>
