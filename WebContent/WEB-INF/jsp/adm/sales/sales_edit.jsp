...
<form action="/DispatcherServlet?command=adm_sales_update_act" method="post" enctype="multipart/form-data">
    ...
    <div class="btn_area">
        ...
        <input type="button" value="삭제" onclick="location.href='/DispatcherServlet?command=adm_sales_remove_act&saleBoardSeq='+'${detail.saleBoardSeq}'"/>
